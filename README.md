...
to misconfigure in a way that can take your server offline, especially
should some of the agressive, less well behaved crawlers find your instance.
...
('bytes_sent') and waited a collective of 15 hours to get said garbage
('delay').
